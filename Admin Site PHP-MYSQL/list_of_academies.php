  ...
  <div id="content">
    ...
    <div class="container-fluid">
     <div style="color:black; font-size:16px">
        ...
        <h3>List Of All Academies</h3>
        <div style="margin-left:200px">
         <button type="button" class="btn btn-success"
                  onclick="window.location.href='gov_academies.php?gov=beirut'">Beiruth gov.
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="button" class="btn btn-success"
                  onclick="window.location.href='gov_academies.php?gov=south'">Shouth Lebanon gov.
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="button" class="btn btn-success"
                  onclick="window.location.href='gov_academies.php?gov=north'">North Lebanon gov.
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="button" class="btn btn-success"
                  onclick="window.location.href='gov_academies.php?gov=mont'">Mont Lebanon gov.
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
      </div><hr>
       <?php
		...
		if (@mysqli_select_db($dbc,'flutter_football'))
        {
            $query="SELECT * FROM profil_team";
             $r=mysqli_query($dbc,$query);
                  ...
                  onclick=\"window.location.href='academie_profile.php?id=$row1[team_id]'\">Academie profile
                  </button>
                                 <td>
