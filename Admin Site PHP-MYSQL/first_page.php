     ...
     <div style="color:black; font-size:16px">
	   ...
	   { 
		...
		if (@mysqli_select_db($dbc,'flutter_football'))
        {
         ...
         <button type="button" class="btn btn-success"
                  onclick="window.location.href='all_ann.php'">See All Uploaded Annoucment
                  </button>
         <hr>
	   ...
	   { 
		...
		if (@mysqli_select_db($dbc,'flutter_football'))
        {
         ...
         ?>
         <button type="button" class="btn btn-success"
                  onclick="window.location.href='all_matches.php'">See All Matches
                  </button>
         <hr>
	   ...
	   { 
		...
		if (@mysqli_select_db($dbc,'flutter_football'))
        {
         ...
         ?>
         <button type="button" class="btn btn-success"
                  onclick="window.location.href='all_results.php'">See All Results
                  </button>
         <hr>
