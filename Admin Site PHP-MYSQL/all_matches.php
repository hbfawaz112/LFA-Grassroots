     ...
     <div style="color:black; font-size:16px">
        <div style="margin-left:200px">
         <button type="button" class="btn btn-success"
                  onclick="window.location.href='gov_matches.php?gov=beirut'">Beiruth gov.
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="button" class="btn btn-success"
                  onclick="window.location.href='gov_matches.php?gov=south'">Shouth Lebanon gov.
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="button" class="btn btn-success"
                  onclick="window.location.href='gov_matches.php?gov=north'">North Lebanon gov.
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="button" class="btn btn-success"
                  onclick="window.location.href='gov_matches.php?gov=mont'">Mont Lebanon gov.
                  </button>
                  &nbsp;&nbsp;&nbsp;&nbsp;
      </div>
